...
export const BecomeVendor = () => {
  return (
    <section className="py-16 bg-rose/10">
        ...
        <div className="max-w-4xl mx-auto bg-white rounded-xl shadow-lg overflow-hidden">
          <div className="flex flex-col lg:flex-row">
            <div className="lg:w-1/2 p-8 lg:p-12 animate-fade-in">
              ...
              <h2 className="text-3xl font-bold mb-4">Join WedConnect as a Vendor</h2>
              <p className="text-gray-600 mb-6">
                Reach more couples, grow your business, and be part of the most trusted wedding vendor network.
              </p>
              <ul className="mb-8">
                {[
                  ...
                  <li key={index} className="flex items-start mb-3 animate-slide-in" style={{ animationDelay: `${0.2 + index * 0.1}s` }}>
              ...
              <Button className="bg-rose hover:bg-rose-dark text-white px-6">
                <UserPlus className="h-5 w-5 mr-2" />
                Become a Vendor
              </Button>
            </div>
            <div className="lg:w-1/2 relative overflow-hidden animate-fade-in" style={{ animationDelay: "0.3s" }}>
              {/* Decorative Elements */}
